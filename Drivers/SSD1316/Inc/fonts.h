...
#ifndef SSD1316_INC_FONTS_H_
#define SSD1316_INC_FONTS_H_


// @source https://github.com/basti79/LCD-fonts/blob/master/5x8_vertikal_LSB_1.h

#define TINY_CHARS_COLS_LENGTH 3
#define TINY_CHARS_COLS_HEIGHT 4
#define TINY_CHARS_COLS_SPACING 1

#define SMALL_CHARS_COLS_LENGTH 5
#define SMALL_CHARS_COLS_HEIGHT 8
#define SMALL_CHARS_COLS_SPACING 0

#define LARGE_CHARS_COLS_LENGTH 7
#define LARGE_CHARS_COLS_HEIGHT 16
#define LARGE_CHARS_COLS_SPACING 1
...
static const uint8_t FONTSMALL[][SMALL_CHARS_COLS_LENGTH] = {
...
static const uint8_t FONTLARGE[][LARGE_CHARS_COLS_LENGTH * 2] = {
    {0xF0, 0xFE, 0x0F, 0x03, 0x0F, 0xFE, 0xF0,  0x0F, 0x7F, 0xF0, 0xC0, 0xF0, 0x7F, 0x0F}, //0
    {0x00, 0x0C, 0x0C, 0xFF, 0xFF, 0x00, 0x00,  0x00, 0xC0, 0xC0, 0xFF, 0xFF, 0xC0, 0xC0}, //1
    {0x1E, 0x1F, 0x03, 0xC3, 0xFF, 0x7E, 0x00,  0xF0, 0xFC, 0xDF, 0xC7, 0xC1, 0xC0, 0xC0}, //2
    {0x0C, 0x0E, 0x87, 0x83, 0xC7, 0xFE, 0x7C,  0x30, 0x70, 0xE1, 0xC1, 0xE3, 0x7F, 0x3E}, //3
    {0xFF, 0xFF, 0x80, 0x80, 0xFF, 0xFF, 0x80,  0x00, 0x01, 0x01, 0x01, 0xFF, 0xFF, 0x01}, //4
    {0x7F, 0x7F, 0x63, 0x63, 0xE3, 0xC3, 0x83,  0x38, 0x78, 0xE0, 0xC0, 0xE0, 0x7F, 0x3F}, //5
    {0xF0, 0xFC, 0xCE, 0xC7, 0xC3, 0x83, 0x00,  0x3F, 0x7F, 0xC0, 0xC0, 0xC1, 0x7F, 0x3E}, //6
    {0x1F, 0x1F, 0x03, 0x03, 0xC3, 0xFF, 0x3F,  0x00, 0x00, 0x00, 0xF8, 0xFF, 0x07, 0x00}, //7
    {0x1C, 0xBE, 0xE3, 0xC3, 0xE3, 0xBE, 0x1C,  0x3F, 0x7F, 0xC1, 0xC0, 0xC1, 0x7F, 0x3F}, //8
    {0x7C, 0xFE, 0xC3, 0x83, 0x83, 0xFE, 0xFC,  0x00, 0xC0, 0xC1, 0xE1, 0x79, 0x3F, 0x0F}, //9
};

static const uint8_t FONTTINY[][TINY_CHARS_COLS_LENGTH] = {
	{0x0F, 0x09, 0x0F}, // 0
    {0x09, 0x0F, 0x08},
    {0x0D, 0x09, 0x0B},
    {0x09, 0x0D, 0x0F},
